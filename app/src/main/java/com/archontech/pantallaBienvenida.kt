 ...
 * Use the [pantallaBienvenida.newInstance] factory method to
 * create an instance of this fragment.
 */
class pantallaBienvenida : Fragment(), View.OnClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<View>(R.id.button_login).setOnClickListener(this)
        view.findViewById<View>(R.id.button_registrar).setOnClickListener(this)
    }

    override fun onClick(v: View) {
        if (v === v.findViewById<View>(R.id.button_login)) {
    ...
    companion object {
        ...
        fun newInstance(param1: String?, param2: String?): pantallaBienvenida {
            val fragment = pantallaBienvenida()
            val args = Bundle()
