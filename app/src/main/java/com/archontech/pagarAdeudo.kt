 ...
 * Use the [pagarAdeudo.newInstance] factory method to
 * create an instance of this fragment.
 */
class pagarAdeudo : Fragment() {
    ...
    companion object {
        ...
        fun newInstance(param1: String?, param2: String?): pagarAdeudo {
            val fragment = pagarAdeudo()
            val args = Bundle()
