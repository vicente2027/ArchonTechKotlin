 ...
 * Use the [compraProveedor.newInstance] factory method to
 * create an instance of this fragment.
 */
class compraProveedor : Fragment() {
    ...
    companion object {
        ...
        fun newInstance(param1: String?, param2: String?): compraProveedor {
            val fragment = compraProveedor()
            val args = Bundle()
