 ...
 * Use the [Proveedores.newInstance] factory method to
 * create an instance of this fragment.
 */
class Proveedores : Fragment() {
    ...
    companion object {
        ...
        fun newInstance(param1: String?, param2: String?): Proveedores {
            val fragment = Proveedores()
            val args = Bundle()
