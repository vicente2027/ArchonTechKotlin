 ...
 * Use the [notificarAdeudo.newInstance] factory method to
 * create an instance of this fragment.
 */
class notificarAdeudo : Fragment() {
    ...
    companion object {
        ...
        fun newInstance(param1: String?, param2: String?): notificarAdeudo {
            val fragment = notificarAdeudo()
            val args = Bundle()
