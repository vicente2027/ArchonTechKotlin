 ...
 */
class Inventario : Fragment(), View.OnClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<View>(R.id.btnModificarProducto).setOnClickListener(this)
        view.findViewById<View>(R.id.btnNuevoProducto).setOnClickListener(this)
        //view.findViewById(R.id.button_registrar).setOnClickListener(this);
    }

    override fun onClick(v: View) {
        if (v === v.findViewById<View>(R.id.btnModificarProducto)) {
            navController!!.navigate(R.id.modificarProducto)
        }
        if (v === v.findViewById<View>(R.id.btnNuevoProducto)) {
    ...
    companion object {
        ...
        fun newInstance(param1: String?, param2: String?): Inventario {
            val fragment = Inventario()
            val args = Bundle()
