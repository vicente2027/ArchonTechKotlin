 ...
 * Use the [perfilDeUsuario.newInstance] factory method to
 * create an instance of this fragment.
 */
class perfilDeUsuario : Fragment() {
    ...
    companion object {
        ...
        fun newInstance(param1: String?, param2: String?): perfilDeUsuario {
            val fragment = perfilDeUsuario()
            val args = Bundle()
