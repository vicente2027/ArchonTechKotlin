 ...
 * Use the [nueva_venta.newInstance] factory method to
 * create an instance of this fragment.
 */
class nueva_venta : Fragment() {
    ...
    companion object {
        ...
        fun newInstance(param1: String?, param2: String?): nueva_venta {
            val fragment = nueva_venta()
            val args = Bundle()
