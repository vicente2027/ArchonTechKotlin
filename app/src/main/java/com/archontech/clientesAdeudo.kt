 ...
 * Use the [clientesAdeudo.newInstance] factory method to
 * create an instance of this fragment.
 */
class clientesAdeudo : Fragment(), View.OnClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<View>(R.id.btnNotificarAdeudo).setOnClickListener(this)
        view.findViewById<View>(R.id.btnPagarAdeudo).setOnClickListener(this)
        //view.findViewById(R.id.button_registrar).setOnClickListener(this);
    }

    override fun onClick(v: View) {
        if (v === v.findViewById<View>(R.id.btnNotificarAdeudo)) {
            navController!!.navigate(R.id.notificarAdeudo)
        }
        if (v === v.findViewById<View>(R.id.btnPagarAdeudo)) {
    ...
    companion object {
        ...
        fun newInstance(param1: String?, param2: String?): clientesAdeudo {
            val fragment = clientesAdeudo()
            val args = Bundle()
