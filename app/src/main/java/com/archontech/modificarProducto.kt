 ...
 * Use the [modificarProducto.newInstance] factory method to
 * create an instance of this fragment.
 */
class modificarProducto : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_modificar_producto, container, false)
    }
    ...
    companion object {
        ...
        fun newInstance(param1: String?, param2: String?): modificarProducto {
            val fragment = modificarProducto()
            val args = Bundle()
