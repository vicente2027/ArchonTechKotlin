 ...
 * Use the [escanearProducto.newInstance] factory method to
 * create an instance of this fragment.
 */
class escanearProducto : Fragment() {
    ...
    companion object {
        ...
        fun newInstance(param1: String?, param2: String?): escanearProducto {
            val fragment = escanearProducto()
            val args = Bundle()
