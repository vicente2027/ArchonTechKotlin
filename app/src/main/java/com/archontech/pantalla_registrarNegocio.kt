 ...
 * Use the [pantalla_registrarNegocio.newInstance] factory method to
 * create an instance of this fragment.
 */
class pantalla_registrarNegocio : Fragment(), View.OnClickListener {
    ...
    companion object {
        ...
        fun newInstance(param1: String?, param2: String?): pantalla_registrarNegocio {
            val fragment = pantalla_registrarNegocio()
            val args = Bundle()
